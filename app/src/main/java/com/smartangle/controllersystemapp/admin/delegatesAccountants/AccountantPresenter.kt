package com.smartangle.controllersystemapp.admin.delegatesAccountants
...
object AccountantPresenter {
    ...
    fun getEditAccountant(webService: WebService, editAccountantRequest: EditAccountantRequest ,activity: Activity, model: ViewModelHandleChangeFragmentclass)
    {

        Log.d("testApi" , "getData")
        webService.editAccountant(editAccountantRequest)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe(object : DisposableObserver<Response<SuccessModel>>() {
                override fun onComplete() {
