...
import com.smartangle.controllersystemapp.admin.productclassification.productsubclassification.FragmentSubProductclassificationCenterAdmin
...
import com.photonect.photographerapp.notificationphotographer.DonePackgae.ProductClassificationAdaptorCenterAdmin
...
class FragmentProductclassificationCenterAdmin : Fragment() {
    ...
    var productAdaptor: ProductClassificationAdaptorCenterAdmin? = null
...
//    }
    ...
    private fun setRecycleViewData(categoriesListResponse: CategoriesListResponse) {
        ...
        if (categoriesListResponse.data?.isNullOrEmpty() == false) {
            ...
            productAdaptor = ProductClassificationAdaptorCenterAdmin(model, categoriesParentList)
                ...
                if (modelSelected is Data) {
                    ...
                    bundle.putInt(WHICH_ADD_PRD_STORE , arguments?.getInt(WHICH_ADD_PRD_STORE)?:R.id.frameLayout_direction)
                        ...
                        UtilKotlin.changeFragmentWithBack(
                            ...
                            FragmentSubProductclassificationCenterAdmin(),
                            bundle)
