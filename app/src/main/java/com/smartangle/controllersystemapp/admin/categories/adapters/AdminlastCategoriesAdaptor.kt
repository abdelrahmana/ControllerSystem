package com.smartangle.controllersystemapp.admin.categories.adapters
...
class AdminlastCategoriesAdaptor(val modelData: ViewModelHandleChangeFragmentclass,
                                 val arrayListOfTutorials:ArrayList<Data>//this method is returning the view for each item in the list
                                 , var onRecyclerItemClickListener: OnRecyclerItemClickListener
) : RecyclerView.Adapter<AdminlastCategoriesAdaptor.ViewHolder>()  {
