package com.smartangle.controllersystemapp.delegates.makeorder.adapter
...
class DelegatelastCategoriesAdaptor(val modelData: ViewModelHandleChangeFragmentclass,
                                    val arrayListOfTutorials:ArrayList<Data>//this method is returning the view for each item in the list
) : RecyclerView.Adapter<DelegatelastCategoriesAdaptor.ViewHolder>()  {
