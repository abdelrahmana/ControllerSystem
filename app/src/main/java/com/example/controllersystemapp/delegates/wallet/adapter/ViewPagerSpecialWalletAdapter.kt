...
import com.example.controllersystemapp.delegates.wallet.fragments.CurrentSpecialWalletFragment
import com.example.controllersystemapp.delegates.wallet.fragments.NewSpecialWalletFragment

class ViewPagerSpecialWalletAdapter(fragment: Fragment) : FragmentStateAdapter(fragment) {
    ...
    override fun createFragment(position: Int): Fragment {
        when (position) {
            0 ->
                fragment =
                    CurrentSpecialWalletFragment()
            1 ->
                fragment =
                    NewSpecialWalletFragment()
