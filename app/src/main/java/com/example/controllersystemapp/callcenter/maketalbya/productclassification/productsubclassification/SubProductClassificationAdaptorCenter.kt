...
class SubProductClassificationAdaptorCenter(val modelData: ViewModelHandleChangeFragmentclass,
                                      val arrayListOfTutorials:ArrayList<Data>//this method is returning the view for each item in the list
) : RecyclerView.Adapter<SubProductClassificationAdaptorCenter.ViewHolder>()  {
