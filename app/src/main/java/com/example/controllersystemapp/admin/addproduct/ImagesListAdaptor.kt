...
class ImagesListAdaptor(
    val modelData: ViewModelHandleChangeFragmentclass, var arrayListOfImagessValues: ArrayList<String> //this method is returning the view for each item in the list
) : RecyclerView.Adapter<ImagesListAdaptor.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            Glide.with(itemView.context).load(itemData).into(itemView.imageItem)
        ...
        private fun onItemClicked(model: ViewModelHandleChangeFragmentclass, position: Int) {
           ...
           // model.setNotifiedItemSelected(arrayListOfImages.get(position)) // update sign up fragment please
            ...
            model.setNotifyItemSelected("select") // notify others to this please
